        ...
        <div class="dropdown-menu media-list dropdown-menu-right">
            ...
            <a href="javascript:;" class="dropdown-item media">
                ...
                <div class="media-body">
                    <h6 class="media-heading">Server Error Reports <i class="fa fa-exclamation-circle text-danger"></i>
                    </h6>
            ...
            <a href="javascript:;" class="dropdown-item media">
                <div class="media-left">
                    <img src="{{ asset('img/user/user-1.jpeg') }}" class="media-object" alt="">
            ...
            <a href="javascript:;" class="dropdown-item media">
                <div class="media-left">
                    <img src="{{ asset('img/user/user-2.jpeg') }}" class="media-object" alt="">
                    <i class="fab fa-facebook-messenger text-blue media-object-icon"></i>
                </div>
                <div class="media-body">
